...
(function() {
    ...
    function detectDevice() {
        ...
        if (isIPad || isAndroidTablet || isKindle) {
            ...
            // Standard tablet dimensions (portrait and landscape)
            (screenWidth >= 768 && screenWidth <= 1024) ||
            (screenHeight >= 768 && screenHeight <= 1024) ||
            // Larger tablets and 2-in-1 devices
            (screenWidth >= 1024 && screenWidth <= 1366 && screenHeight <= 1024) ||
            (screenHeight >= 1024 && screenHeight <= 1366 && screenWidth <= 1024) ||
            // Viewport-based detection for landscape tablets
            (viewportWidth >= 768 && viewportWidth <= 1366 && isTouchDevice) ||
            (viewportHeight >= 768 && viewportHeight <= 1366 && isTouchDevice)
        )) {
            deviceType = 'tablet';
            deviceClass = 'tablet';
        }
    ...
    // Additional orientation change detection for better tablet support
    window.addEventListener('orientationchange', function() {
    ...
    // Listen for viewport changes (useful for tablets)
    ...
    window.addEventListener('resize', function() {
        ...
        // If viewport dimensions changed significantly, re-detect device
